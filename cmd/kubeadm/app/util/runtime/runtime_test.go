...
func TestNewContainerRuntime(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid: default cri socket", execLookPathOK, kubeadmapiv1beta1.DefaultDockerCRISocket, true, false},
...
func TestIsRunning(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid: docker is running", kubeadmapiv1beta1.DefaultDockerCRISocket, dockerExecer, false},
		{"invalid: docker is not running", kubeadmapiv1beta1.DefaultDockerCRISocket, dockerExecer, true},
	}
...
func TestListKubeContainers(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid: list containers using docker", kubeadmapiv1beta1.DefaultDockerCRISocket, false},
	}
...
func TestRemoveContainers(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid: remove containers using docker", kubeadmapiv1beta1.DefaultDockerCRISocket, []string{"k8s_c1", "k8s_c2", "k8s_c3"}, false},
		{"invalid: remove containers using docker", kubeadmapiv1beta1.DefaultDockerCRISocket, []string{"k8s_c1", "k8s_c2", "k8s_c3"}, true},
	}
...
func TestPullImage(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid: pull image using docker", kubeadmapiv1beta1.DefaultDockerCRISocket, "image1", false},
		{"invalide: docer pull error", kubeadmapiv1beta1.DefaultDockerCRISocket, "image2", true},
	}
...
func TestImageExists(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid: test if image exists using docker", kubeadmapiv1beta1.DefaultDockerCRISocket, "image1", false},
		{"invalid: docker inspect failure", kubeadmapiv1beta1.DefaultDockerCRISocket, "image2", true},
	}
...
func TestDetectCRISocketImpl(t *testing.T) {
	tests := []struct {
		...
		{
			name:            "No existing sockets leads to an error",
			existingSockets: []string{},
			expectedError:   true,
		},
		{
		...
		},
		{
			...
			expectedError:   false,
			expectedSocket:  kubeadmapiv1beta1.DefaultDockerCRISocket,
		},
		{
